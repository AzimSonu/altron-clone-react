  ...
  return (
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6x1 mx-auto'>
        ...
        <div className="md:w-[50%] mb-12 md:6">
          <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8a2V5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60" alt="key" 
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          ...
          <input className="w-full" type="text" id="name" value={name} onChange={onChange}
            ...
            <input className="w-full" type={showPassword ? "text" : "password"} id="password" value={password} onChange={onChange}
            placeholder="Password"
            // eslint-disable-next-line react/jsx-no-duplicate-props
            className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"
            />
            {showPassword ? (
              <AiFillEyeInvisible className="absolute right-3 top-3 text-x1 cursor-pointer" onClick = {() => setShowPassword ((prevState)=> !prevState)} />
            ): (<AiFillEye className="absolute right-3 top-3 text-x1 cursor-pointer" onClick = {() => setShowPassword ((prevState)=> !prevState)}/>)}
            </div>
